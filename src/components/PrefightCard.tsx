...
export function PrefightCard({ player, opponent, mode, onStart }: { player: FighterInfo; opponent: FighterInfo; mode: GameMode; onStart: () => void }) {
  return <div className="prefight-card" role="dialog" aria-modal="true" aria-label="Tale of the tape">
    <header><small>FIGHTRON MMA · {mode.toUpperCase()}</small><h1>TALE OF THE TAPE</h1></header>
