...
export const modeFighters = (mode: GameMode) => mode === 'normal'
  ? [fighters.agent, fighters.officer]
  : mode === 'career' ? [fighters.agent, fighters.officer, fighters.conor, fighters.islam, fighters.khabibi, fighters.chalres]
  : ['mma', 'shootout', 'short', 'brawl'].includes(mode) ? [fighters.agent, fighters.john, fighters.conor, fighters.islam, fighters.khabibi, fighters.chalres] : Object.values(fighters)
